...
function EmergencyRequest({ onProceed }) {
  ...
  return (
    <div className="min-h-screen font-sans bg-green-50">
      ...
      {/* HOME SECTION */}
      <section id="home" className="scroll-mt-20 p-5">
        ...
        <div className="relative flex justify-center mb-8">
          ...
          >
            ...
            <div className="text-sm opacity-90 mt-1">⚡ fast response time</div>
          </button>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-white p-8 rounded-2xl border-2 border-blue-200 shadow-lg">
              <div className="text-5xl mb-4">💡</div>
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Smart Tech</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Impact */}
            <div className="bg-gradient-to-br from-red-50 to-white p-8 rounded-2xl border-2 border-red-200 shadow-lg">
              <div className="text-5xl mb-4">❤️</div>
              <h3 className="text-2xl font-bold mb-3 text-gray-900">Our Impact</h3>
              <p className="text-gray-700 leading-relaxed">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-4xl font-black text-[#FF3B30]">500+</div>
              <div className="text-sm text-gray-600 mt-2">Lives Saved</div>
            </div>
          
            <div className="text-center">
              <div className="text-4xl font-black text-[#FF3B30]">24/7</div>
              <div className="text-sm text-gray-600 mt-2">Availability</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-black text-[#FF3B30]">98%</div>
      ...
      {/* SERVICES SECTION */}
      <section id="services" className="py-20 px-6 bg-[#e8f5e9] scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-black text-center mb-4 text-gray-900">
            Our Services
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Emergency Response */}
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="flex items-start gap-4 mb-4">
                <div className="text-5xl">🚑</div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Emergency Ambulance</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="mt-4 flex gap-2 flex-wrap">
                <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-semibold">Medical Emergency</span>
                <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-semibold">Accidents</span>
                <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-semibold">Critical Care</span>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="flex items-start gap-4 mb-4">
                <div className="text-5xl">📍</div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Live GPS Tracking</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="mt-4 flex gap-2 flex-wrap">
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">Real-Time Updates</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">Route Optimization</span>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-shadow">
              <div className="flex items-start gap-4 mb-4">
                <div className="text-5xl">🏥</div>
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Hospital Network</h3>
                  <p className="text-gray-700 leading-relaxed">
              ...
              <div className="mt-4 flex gap-2 flex-wrap">
                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-semibold">Bed Availability</span>
                <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-semibold">Pre-Registration</span>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl border-2 border-gray-200 hover:shadow-2xl transition-shadow">
              ...
              <div className="mt-4 flex gap-2 flex-wrap">
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold">Always Available</span>
                <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold">Instant Response</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <button 
              ...
              className="px-10 py-4 bg-[#FF3B30] text-white rounded-xl font-bold text-lg shadow-lg hover:bg-[#e63329] transition-all hover:shadow-xl"
            >
